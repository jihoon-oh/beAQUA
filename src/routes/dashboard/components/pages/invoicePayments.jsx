...
class Main extends React.Component {
    constructor(props){
     ...
     this.state = {
        ...
        recurringNo: 'btn_inv_active',
        recurringYes: '',
        recurring: 'No',
        recurringFrequency: 'hide',
        invoiceFrequency: 'Every Monday',
        count: 1,
        option: {
                    ...
                    <div className="container-fluid">
                        <div className="row mb30_">
                            <div className="col-xs-12 col-md-offset-2 col-md-4">
                                ...
                                <input className="form-control" placeholder="" type="text" value={this.state.invoiceNumber} onChange={(e)=>{this.setState({invoiceNumber: e.target.value})}} />
                            </div>
                            <div className="col-xs-12 col-md-4">
                                <label>Invoice date</label>
                                <input className="form-control" placeholder="" type="date" value={this.state.invoiceDate} onChange={(e)=>{this.setState({invoiceDate: e.target.value})}} />
                            </div>
                        </div>
                        <div className="row mb30_">
                            <div className="col-xs-12 col-md-offset-2 col-md-4">
                                ...
                                <div>
                                    <div onClick={()=>{
                                        ...
                                        }} className={"btn_inv "+this.state.recurringNo}>No</div>
                                    <div onClick={()=>{
                                            this.setState({
                                                recurringNo: '',
                                                recurringYes: 'btn_inv_active',
                                                recurring: 'Yes',
                                                recurringFrequency: ''
                                            })
                                    }} className={"btn_inv "+this.state.recurringYes}>Yes</div>
                                </div>
                            </div>
                            <div className={'col-xs-12 col-md-4 '+this.state.recurringFrequency}>
                                <label>Frequency</label>
                                <select className="form-control" value={this.state.invoiceFrequency} onChange={(e)=>{this.setState({invoiceFrequency: e.target.value})}}>
                                    ...
                                    <option value="Every 1st of the month">Every 1st of the month</option>
                                    <option value="Every 2nd of the month">Every 2nd of the month</option>
                                    <option value="Every 3rd of the month">Every 3rd of the month</option>
                                    <option value="Every 4th of the month">Every 4th of the month</option>
                                    <option value="Every 5th of the month">Every 5th of the month</option>
                                    <option value="Every 6th of the month">Every 6th of the month</option>
                                    <option value="Every 7th of the month">Every 7th of the month</option>
                                    <option value="Every 8th of the month">Every 8th of the month</option>
                                    <option value="Every 9th of the month">Every 9th of the month</option>
                                    <option value="Every 10th of the month">Every 10th of the month</option>
                                    <option value="Every 11th of the month">Every 11th of the month</option>
                                    <option value="Every 12th of the month">Every 12th of the month</option>
                                    <option value="Every 13th of the month">Every 13th of the month</option>
                                    <option value="Every 14th of the month">Every 14th of the month</option>
                                    <option value="Every 15th of the month">Every 15th of the month</option>
                                    <option value="Every 16th of the month">Every 16th of the month</option>
                                    <option value="Every 17th of the month">Every 17th of the month</option>
                                    <option value="Every 18th of the month">Every 18th of the month</option>
                                    <option value="Every 19th of the month">Every 19th of the month</option>
                                    <option value="Every 20th of the month">Every 20th of the month</option>
                                    <option value="Every 21st of the month">Every 21st of the month</option>
                                    <option value="Every 22nd of the month">Every 22nd of the month</option>
                                    <option value="Every 23rd of the month">Every 23rd of the month</option>
                                    <option value="Every 24th of the month">Every 24th of the month</option>
                                    <option value="Every 25th of the month">Every 25th of the month</option>
                                    <option value="Every 26th of the month">Every 26th of the month</option>
                                    <option value="Every 27th of the month">Every 27th of the month</option>
                                    <option value="Every 28th of the month">Every 28th of the month</option>
                                    <option value="Every 29th of the month">Every 29th of the month</option>
                                    <option value="Every 30th of the month">Every 30th of the month</option>
                                    <option value="Every 31st of the month">Every 31st of the month</option>
                        ...
                        <div className="row mb30_">
                            ...
                            <div id="addMoreProductInvoice2" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice3" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice4" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice5" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice6" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice7" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice8" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice9" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div id="addMoreProductInvoice10" className="hide">
                                <div className="col-xs-12 col-md-offset-2 col-md-4 mb30_">
                            ...
                            <div className="col-xs-12 text-center cursorPointer" onClick={(e)=>{
                                if(this.state.count < 10){
                                    document.getElementById('addMoreProductInvoice'+(this.state.count + 1)).classList.remove('hide')
                                ...
                                <button className="btn_"
                                    onClick={(e)=>{
                                        ...
                                        post_(
                                            ...
                                            if(res.length === 69){
                                                window.open('/dashboard/preview/'+res, '_blank');
                                            }
                                        }).catch(()=>{})
                                    }}
                                >Preview</button>
